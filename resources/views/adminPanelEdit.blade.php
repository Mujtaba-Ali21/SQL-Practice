        ...
        <div class="col-md-10 register-right customShadow">
          ...
          <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active">
              <h3 class="register-heading">Edit Entry</h3>
              <div class="row register-form">
                ...
                <div class="col-md-12">
                  <form method="POST" action="{{ url('editRow/'.$data->ID) }}" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                      ...
                      <input class="form-control mt-3" type="number" min="1" max="5" name="rating" placeholder="Ratings" value="{{ $data->rating }}">
                      <input class="form-control mt-2" type="text" name="message" placeholder="Feedback" value="{{ $data->message }}">

                      @foreach ($data->votes as $vote)
                        <input class="form-control mt-2" type="number" min="0" name="helpful_count" placeholder="Helpful Count" value="{{ $vote->helpful }}">
                        <input class="form-control mt-2" type="number" min="0" name="unhelpful_count" placeholder="Unhelpful Count" value="{{ $vote->unhelpful }}">
                      @endforeach
