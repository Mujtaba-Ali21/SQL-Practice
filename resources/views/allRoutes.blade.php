        ...
        <div class="col-md-10 register-right customShadow">
          <ul class="nav nav-tabs nav-justified">
            <li class="nav-item p-2">
              <a href="/adminPanel">
                <span class="nav-new" id="profile-tab"> Go Back </span>
              </a>
            </li>
          </ul>
          <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active">
              <h3 class="register-heading">Access All Routes</h3>
              <div class="row register-form">
                @if($errors->any())
                <div
                  class="alert mb-5 pt-2 px-5 text-dark shadow rounded mx-auto"
                  style="background-color: #02c2fd; width: 25rem"
                >
                  <ol>
                  ...
                  >
                    ...
                    <div class="form-group">
                      <select id="routeSelect">
                        <optgroup label="Select a Route">
                          <option value="http://localhost:8000/">Main</option>
                          <option value="http://localhost:8000/createProduct">
                            Create Product
                          </option>
                          <option value="http://localhost:8000/QnATable">
                            Question and Answers
                          </option>
                          <option value="http://localhost:8000/adminPanel">
                            Admin Panel
                          </option>
                        </optgroup>
                      </select>
    ...
    <script>
      $(document).ready(function () {
        $("#redirectForm").on("submit", function (e) {
          ...
          var selectedValue = $("#routeSelect").val();
